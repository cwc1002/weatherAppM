 ...
 * @param {*} eventType Event Type e.g.: "click", "mousover"
...
/**
 * Render all weather data in html pape
 * 
...
export const updateWeather = function (lat, lon) {
  ...
  const currentWeatherSection = document.querySelector("[data-current-weatehr]");
    ...
    fetchData(url.forecast(lat, lon), function(forecast){
        ...
        tempLi.innerHTML = `
          <div class="card card-sm slider-card">
            ...
            <img src="./assets/images/weather_icons/${icon}.png" width="48" height="48" loading="lazy" alt="${description}" 
              class="weater-icon" title="${description}">
        ...
        windLi.innerHTML = `
          <div class="card card-sm slider-card">
            ...
            <img src="./assets/images/weather_icons/direction.png" width="48" height="48" loading="lazy" alt="direction" 
              class="weater-icon" style="transform: rotate(${windDirection - 180}deg)">
      ...
      for (let i = 7, len = forecastList.length; i < len; i += 8) {
        ...
        li.innerHTML = `
          ...
          <p class="label-1">${module.monthNames[date.getMonth()]} ${date.getDate()}일</p>
